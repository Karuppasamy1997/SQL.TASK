...
INSERT INTO KARUPPASAMY_EMPLOYEE (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,SALARY,DEPARTMENT_ID,YEAR_OF_JOINING,YEAR_OF_RELIEVING)VALUES
    ...
    (12,'Kumar','Riyaz',18000,90,'12-01-2022' ,'06-03-2022'),
    (13,'ARUN','KUMAR',2000,10,'2016-03-03','2019-04-04'),
    (14,'VARUN','KUMAR',2500,12,'2016-06-05','2019-02-04'),
    (15,'SARAN','KUMAR',5000,32,'2015-06-05','2019-08-04'),
    (16,'SARATH','KUMAR',6000,90,'2015-06-05','2019-08-04'),
    (17,'SARAN','KUMAR',6000,30,'2017-03-11','2019-08-04');
	SELECT * FROM KARUPPASAMY_DEPARTMENT;

    --20. Display years in which more than 10 employees joined.
	SELECT YEAR(YEAR_OF_JOINING), COUNT(YEAR_OF_JOINING) AS "YEAR" FROM  KARUPPASAMY_EMPLOYEE GROUP BY 
	YEAR(YEAR_OF_JOINING) HAVING COUNT(MONTH(YEAR_OF_JOINING))>10;
    SELECT * FROM KARUPPASAMY_EMPLOYEE;
-- 21.  Display employee ID for jobs with average salary more than 10000. 
    SELECT AVG(SALARY) EMPLOYEE_ID
	FROM KARUPPASAMY_EMPLOYEE HAVING AVG(SALARY)>=10000;
	-- 22. Display the number of days between working for all employees.
    SELECT EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DATEDIFF(DAY,YEAR_OF_JOINING,YEAR_OF_RELIEVING) AS "DATEOFREFF" FROM KARUPPASAMY_EMPLOYEE;

-- 23. Display employees who joined in the current year.  
   SELECT * FROM KARUPPASAMY_EMPLOYEE WHERE YEAR(YEAR_OF_JOINING) = YEAR(GETDATE());
...
-- 25. Display the length of first name for employees where last name contain character ‘b’ after 3rd position.
    SELECT FIRST_NAME,LEN(FIRST_NAME) AS FIRST_NAME_LENGTH,CHARINDEX('N',LAST_NAME) AS INDEXES FROM KARUPPASAMY_EMPLOYEE WHERE CHARINDEX(LAST_NAME,'V') > 3;
